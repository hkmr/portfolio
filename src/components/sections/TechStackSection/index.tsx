...
const stackData = {
  data: [
    {
      title: "Frontend Tech",
      description: "Experience working in frontend with javascript and typescript including framework React and Next JS.",
      icons: ["/assets/icons/next-js.svg", "/assets/icons/react-js.svg", "/assets/icons/typescript.svg", "/assets/icons/javascript.svg"],
    },
    {
      title: "Backend Tech",
      description: "Experience working in backend with java and javascript including framework Spring boot and Node(Nest Js).",
      icons: ["/assets/icons/spring-boot.svg", "/assets/icons/node.svg", "/assets/icons/java.svg", "/assets/icons/typescript.svg", "/assets/icons/javascript.svg"],
    },
    {
